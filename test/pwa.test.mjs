...
test("the service worker caches a versioned shell and only falls back to HTML for navigations", () => {
  ...
  for (const moduleName of ["effects", "history", "input-adapter", "midi", "midi-file", "migrations", "performance-engine", "recording", "sample-editor", "sequencer", "transport", "voice-registry"]) {

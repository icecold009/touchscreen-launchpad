const CACHE_NAME = "touchscreen-launchpad-v21";
const CACHE_PREFIX = "touchscreen-launchpad-";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css",
  "./src/bootstrap.js?version=21",
  "./app.js?version=21",
  "./src/pointer-state.js?version=21",
  "./src/storage-request.js?version=21",
  "./src/download.js?version=21",
